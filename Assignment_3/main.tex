...
\section{Solution}
\begin{center}
    \includegraphics[width = 7cm, height = 7cm]{figures/figure.png}
\end{center}

In the above figure, rectangle ABCD represents sample space of (X, Y). $Y \le X$ for any point $(X, Y)$ if and only if the point lies on or below line EF. Therefore 
\begin{align}
